...
from .functions import regex_get_filepart_of_string, check_md5sum, get_md5sum, check_md5sum, get_md5sum
from .constants import FILESIZE_LIMIT, WORKTABLE, EXT_YAML,VERSION
...
class File:
    ...
    def split(self)->List[Chunk]:
        ...
        completedProcess = subprocess.run(cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
