...
# Umbral mínimo para mostrar la barra (100 MB)
# Archivos menores a esto se procesan en menos de 200ms y no parpadean en la UI
HASH_VISUAL_THRESHOLD = 100 * 1024 * 1024
